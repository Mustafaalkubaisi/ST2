...
# Example usage:
unsorted_list = [64, 25, 12, 22, 11, 4, 1, 5, 7, 100, 101, 102, 103, 104, 105, 106, 109]
...
# Example usage:
unsorted_list = [64, 1, 12, 22, 11, 4, 10, 5, 7, 100, 101, 102, 103, 104, 105, 106, 109]
...
unsorted_list = [random.randint(1, data) for _ in range(10000)]
sorted_list = insertion_sort(unsorted_list)
insertion_sort_time = timeit.timeit(lambda: insertion_sort(unsorted_list.copy()), number=1)
linear_time = timeit.timeit(lambda: linear_search(sorted_list, target), number=100)
insertion_linear = insertion_sort_time + linear_time
print(f"Insertion sort + Linear search execution time: {insertion_linear:.6f} seconds")

unsorted_list = [random.randint(1, data) for _ in range(10000)]
sorted_list = bubble_sort(unsorted_list)
bubble_sort_time = timeit.timeit(lambda: bubble_sort(unsorted_list.copy()), number=1)
linear_time = timeit.timeit(lambda: linear_search(sorted_list, target), number=100)
bubble_linear = bubble_sort_time + linear_time
print(f"bubble sort + Linear search execution time: {bubble_linear:.6f} seconds")

unsorted_list = [random.randint(1, data) for _ in range(10000)]
sorted_list = insertion_sort(unsorted_list)
insertion_sort_time = timeit.timeit(lambda: insertion_sort(unsorted_list.copy()), number=1)
binary_time = timeit.timeit(lambda: binary_search(sorted_list, target), number=100)
insertion_binary = insertion_sort_time + binary_time
print(f"Insertion sort + binary search execution time: {insertion_binary:.6f} seconds")

unsorted_list = [random.randint(1, data) for _ in range(10000)]
sorted_list = bubble_sort(unsorted_list)
bubble_sort_time = timeit.timeit(lambda: bubble_sort(unsorted_list.copy()), number=1)
binary_time = timeit.timeit(lambda: binary_search(sorted_list, target), number=100)
bubble_binary = bubble_sort_time + binary_time
print(f"bubble sort + binary search execution time: {bubble_binary:.6f} seconds")
